    ...
    <section className="hero-gradient py-20 md:py-28">
      <div className="container mx-auto flex flex-col items-center gap-12 px-6 md:flex-row">
        <div className="flex-1 space-y-6 text-center md:text-left">
          <h1 className="text-4xl font-extrabold text-primary-foreground md:text-5xl lg:text-6xl">
            Welcome to Dripl
          </h1>
          ...
          <a
            ...
            className="inline-block rounded-lg bg-accent px-6 py-3 font-semibold text-accent-foreground shadow-lg transition-transform hover:scale-105"
          >
            Get Started →
          </a>
        </div>
